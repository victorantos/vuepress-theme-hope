...
import { DefaultMatchResultItem, MatchResult, RenderType } from "./typings";
...
export class PageSearcher {
  ...
  #search: (query: SearchQuery) => Promise<NormalizedSearchResultItem[]>;
  ...
  async init() {
    await createSearchIndex(this.#options);
  }
