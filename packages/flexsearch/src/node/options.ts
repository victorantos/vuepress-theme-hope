...
export interface flexsearchPluginOptions
  extends DeprecatedflexsearchPluginOptions {
  /**
   ...
   * Locales config
   *
   * @see [default config](https://github.com/vuepress-theme-hope/vuepress-theme-hope/blob/main/packages/flexsearch/src/node/locales.ts)
   *
   * 多语言选项
   *
