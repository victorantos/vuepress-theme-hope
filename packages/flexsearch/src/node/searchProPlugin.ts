...
import { flexsearchLocales } from "./locales.js";
...
export const flexsearchPlugin =
  (options: flexsearchPluginOptions, legacy = true): PluginFunction =>
  (app) => {
    // TODO: Remove this in v2 stable
    if (legacy)
      convertOptions(
        options as flexsearchPluginOptions & Record<string, unknown>,
      );
